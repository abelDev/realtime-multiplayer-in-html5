...
var dashcodePartSpecs = {
    ...
    "button11": { "initialHeight": 30, "initialWidth": 123, "leftImageWidth": 15, "onclick": "Question3", "rightImageWidth": 15, "text": "CheckAnswer", "view": "DC.PushButton" },
    "button12": { "initialHeight": 30, "initialWidth": 123, "leftImageWidth": 15, "onclick": "Question3", "rightImageWidth": 15, "text": "CheckAnswer", "view": "DC.PushButton" },
    ...
    "button5": { "initialHeight": 30, "initialWidth": 123, "leftImageWidth": 15, "onclick": "Question3", "rightImageWidth": 15, "text": "CheckAnswer", "view": "DC.PushButton" },
    ...
    "button7": { "initialHeight": 30, "initialWidth": 123, "leftImageWidth": 15, "onclick": "Question3", "rightImageWidth": 15, "text": "CheckAnswer", "view": "DC.PushButton" },
    ...
    "Qst1": { "text": "What does MLA stand for?", "view": "DC.Text" },
    "RenderQuestion": { "subviewsTransitions": [{ "direction": "right-left", "duration": "", "timing": "ease-in-out", "type": "push" }, { "direction": "right-left", "duration": "", "timing": "ease-in-out", "type": "push" }, { "direction": "right-left", "duration": "", "timing": "ease-in-out", "type": "push" }, { "direction": "right-left", "duration": "", "timing": "ease-in-out", "type": "push" }, { "direction": "right-left", "duration": "", "timing": "ease-in-out", "type": "push" }, { "direction": "right-left", "duration": "", "timing": "ease-in-out", "type": "push" }, { "direction": "right-left", "duration": "", "timing": "ease-in-out", "type": "push" }, { "direction": "right-left", "duration": "", "timing": "ease-in-out", "type": "push" }], "view": "DC.StackLayout" },
    ...
    "text10": { "text": "What 2 things does MLA define?", "view": "DC.Text" },
    ...
    "text20": { "text": "Name three Articles", "view": "DC.Text" },
    "text21": { "text": "Article 1", "view": "DC.Text" },
    "text22": { "text": "Atricle 2", "view": "DC.Text" },
    "text23": { "text": "Article 3", "view": "DC.Text" },
    "text24": { "text": "Is the sentence COMPOUND or COMPLEX?", "view": "DC.Text" },
    "text25": { "text": "I did my homework after the rainstorm passed.", "view": "DC.Text" },
    ...
    "Text4": { "text": "Question 4", "view": "DC.Text" },
    "text5": { "text": "Green", "view": "DC.Text" },
    "Text5": { "text": "Question 5", "view": "DC.Text" },
    "text6": { "text": "The Green Team, an  classic chice!", "view": "DC.Text" },
    "Text6": { "text": "Question 6", "view": "DC.Text" },
